...
@Autonomous
public class RedBlockNew extends LinearOpMode {
...
// }
      ...
      encoderDrive(1.0,  -6,  6, 6,  -6);
      //correct();
        encoderDrive(1.0,  2,  2, 2,  2);
        sleep(200);
      if(color_sensor.red() - color_sensor.blue()<200){

        dist = 0.0;

      }else if(color_sensor2.red() - color_sensor2.blue()<300){
            dist += 17.0;
        ...
        encoderDrive(1.0,  2,  2, 2,  2);
        if(color_sensor.red() - color_sensor.blue()<300){
      ...
      encoderDrive(1.0, -back, -back, -back, -back);
      ...
      encoderDrive(1.0,  -12.0,  12.0, 12.0, -12.0);
